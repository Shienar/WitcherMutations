...
{
    public class CustomItemSlot_Mutation : UIElement
    {
        ...
        public event ItemChangedEventHandler_Mutation ItemChanged;
        public event ItemVisiblityChangedEventHandler_Mutation ItemVisibilityChanged;
        ...
        /// </summary>
        public CustomItemSlot_Mutation Partner { get; set; }
        /// <summary>
        ...
        public CustomItemSlot_Mutation(int context = ItemSlot.Context.ModdedAccessorySlot, float scale = 1f,
        ...
        protected internal class ToggleVisibilityButton : UIElement
        {
            ...
            protected override void DrawSelf(SpriteBatch spriteBatch)
            {
                if (Parent is not CustomItemSlot_Mutation slot) return;
            ...
            protected void DoDraw(SpriteBatch spriteBatch, CustomItemSlot_Mutation slot)
            {
